// 欠落しているユーザープロフィールを修正するスクリプト（一時版）
const { createClient } = require('@supabase/supabase-js');

// ⚠️ 一時的な設定 - Supabase Dashboardから取得したキーをここに貼り付けてください
const SUPABASE_URL = 'https://your-project-id.supabase.co';
const SUPABASE_SERVICE_ROLE_KEY = 'ここにService Role Keyを貼り付けてください';

if (SUPABASE_SERVICE_ROLE_KEY === 'ここにService Role Keyを貼り付けてください') {
  console.error('❌ エラー: SUPABASE_SERVICE_ROLE_KEY を設定してください');
  console.error('   Supabase Dashboard > Settings > API > service_role key をコピーして貼り付けてください');
  process.exit(1);
}
